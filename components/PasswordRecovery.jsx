...
var Step;
(function (Step) {
    Step[Step["EMAIL"] = 0] = "EMAIL";
    Step[Step["CODE"] = 1] = "CODE";
    Step[Step["NEW_PASSWORD"] = 2] = "NEW_PASSWORD";
    Step[Step["SUCCESS"] = 3] = "SUCCESS";
})(Step || (Step = {}));
const PasswordRecovery = () => {
    ...
    return (<div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8 animate-fade-in">
        ...
        {step === Step.EMAIL && (<form onSubmit={handleSendCode}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-white border border-slate-300 rounded-lg pl-10 pr-4 py-2.5 text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500" placeholder="you@example.com"/>
                        </div>
                    </div>
        ...
        {step === Step.CODE && (<form onSubmit={handleVerifyCode}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input type="text" required maxLength={6} value={code} onChange={(e) => setCode(e.target.value)} className="w-full bg-white border border-slate-300 rounded-lg px-4 py-2.5 text-center text-2xl tracking-widest text-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-500 font-mono" placeholder="000000"/>
                    </div>
        ...
        {step === Step.NEW_PASSWORD && (<form onSubmit={handleResetPassword}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="password" required minLength={6} value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full bg-white border border-slate-300 rounded-lg pl-10 pr-4 py-2.5 text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500" placeholder="••••••••"/>
                        </div>
                    </div>
        ...
        {step === Step.SUCCESS && (<div className="text-center py-4">
                ...
                <button onClick={() => navigate('/login')} className="w-full bg-amber-600 text-white font-bold py-2.5 rounded-lg hover:bg-amber-700 transition-colors">
